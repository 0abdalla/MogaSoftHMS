...
public interface IStoreService
{
    ...
    Task<ErrorResponseModel<List<StoreRateResponse>>> GetStoreRateAsync(int storeId, DateOnly fromDate, DateOnly toDate, CancellationToken cancellationToken = default);

    Task<ErrorResponseModel<List<MainGroupResponseV2>>> GetItemsOrderLimitAsyncV2(int storeId, CancellationToken cancellationToken = default);
    Task<ErrorResponseModel<List<StoreRateResponseV2>>> GetStoreRateAsyncV2(int storeId, DateOnly fromDate, DateOnly toDate, CancellationToken cancellationToken = default);
