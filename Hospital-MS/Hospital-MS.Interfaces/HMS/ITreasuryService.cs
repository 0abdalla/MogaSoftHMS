...
public interface ITreasuryService
{
    ...
    Task<ErrorResponseModel<string>> DisableTreasuryMovementAsync(int id, DateOnly closeInDate, CancellationToken cancellationToken = default);
    ...
    Task<ErrorResponseModel<string>> ReDisableTreasuryMovementAsync(int id, CancellationToken cancellationToken = default);
}
