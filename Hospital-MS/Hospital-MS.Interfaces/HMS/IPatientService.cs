...
namespace Hospital_MS.Interfaces.HMS
{
    ...
    {
        Task<PagedResponseModel<List<PatientListResponse>>> GetAllAsync(PagingFilterModel pagingFilter,CancellationToken cancellationToken = default);
        ...
        Task<ErrorResponseModel<PatientListResponse>> GetByIdAsync(int id, CancellationToken cancellationToken = default);
